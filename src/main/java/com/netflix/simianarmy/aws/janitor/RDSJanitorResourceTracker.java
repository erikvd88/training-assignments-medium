...
public class RDSJanitorResourceTracker implements JanitorResourceTracker {
    ...
    public void addOrUpdate(Resource resource) {
    	...
    	if (orig == null) {
    		this.insertlogger(resource, this.insertRows());
    	} else {
    		this.updatelogger(resource, this.updateRows());
    	}
    	LOGGER.debug("Successfully saved.");
    }
    		
	public StringBuilder insertRows() {
	...
	public StringBuilder updateRows() {
		StringBuilder sb = new StringBuilder();
	...
	public void insertlogger(Resource resource, StringBuilder sb) {
